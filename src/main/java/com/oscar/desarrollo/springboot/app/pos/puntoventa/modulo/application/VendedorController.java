...
public class VendedorController {
    ...
    public ResponseEntity<VendedorResponseModel> crearProducto(@RequestBody VendedorModelRequest request) {
    ...
    public ResponseEntity<VendedorResponseModel> actualizarProducto(@PathVariable Long id, @RequestBody VendedorModelRequest request) {
